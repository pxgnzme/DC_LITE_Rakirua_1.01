...
class rakAGM extends Page {
    ...
    public function getCMSFields() {
      ...
      $gridfield = new GridField("AgmAgenda", "Agm Agenda", AgmAgenda::get(), $gridFieldConfig);

      $fields->addFieldToTab('Root.Content.Agenda', $gridfield);

      return $fields;    
    }
}
 
class rakAGM_Controller extends Page_Controller {
