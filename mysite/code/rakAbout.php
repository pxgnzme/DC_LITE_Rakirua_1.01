...
class rakAbout extends Page {
    ...
    public function getCMSFields() {
      ...
      $gridfield = new GridField("AgmMembers", "Agm Members", AgmMembers::get(), $gridFieldConfig);

      $fields->addFieldToTab('Root.Content.Members', $gridfield);

      return $fields;    
    }
}
 
class rakAbout_Controller extends Page_Controller {
